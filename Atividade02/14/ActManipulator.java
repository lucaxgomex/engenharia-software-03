// https://github.com/blundell/QuickSand/tree/master/core/src/main/java/com/blundell/quicksand (Original)
...
class ActManipulator {
    ...
    private final AnimationInterface animationTracker;
    private final DurationCalculator durationCalculator;
    private final ViscosityInterpolatorMap viscosityCollection;

    private boolean preRunDurationSet = true;

    ActManipulator(AnimationInterface animationTracker, DurationCalculator durationCalculator, ViscosityInterpolatorMap viscosityCollection) {
